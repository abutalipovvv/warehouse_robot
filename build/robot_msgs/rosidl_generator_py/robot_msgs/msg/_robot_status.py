...
class RobotStatus(metaclass=Metaclass_RobotStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.localization_age_sec = kwargs.get('localization_age_sec', float())
        self.state = kwargs.get('state', str())
        self.message = kwargs.get('message', str())
        self.target_lm = kwargs.get('target_lm', str())
        self.nearest_lm = kwargs.get('nearest_lm', str())
    ...
    def __eq__(self, other):
        ...
        if self.localization_ok != other.localization_ok:
            return False
        if self.localization_age_sec != other.localization_age_sec:
            return False
        ...
        if self.target_lm != other.target_lm:
            return False
        if self.nearest_lm != other.nearest_lm:
            return False
    ...
    @builtins.property
    def localization_age_sec(self):
        """Message field 'localization_age_sec'."""
        return self._localization_age_sec

    @localization_age_sec.setter
    def localization_age_sec(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'localization_age_sec' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'localization_age_sec' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._localization_age_sec = value
    ...
    @builtins.property
    def nearest_lm(self):
        """Message field 'nearest_lm'."""
        return self._nearest_lm

    @nearest_lm.setter
    def nearest_lm(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'nearest_lm' field must be of type 'str'"
        self._nearest_lm = value
