...
@dataclass(frozen=True)
class TrafficZone:
    """Map-authored geometric traffic policy.

    The editor stores geometry, not graph annotations.  At load time the core
    compiles a controlled corridor into graph resources and safe stop lines.
    """
