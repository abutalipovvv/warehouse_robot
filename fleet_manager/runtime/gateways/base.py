"""Transport contracts between fleet policy and robot execution."""
...
class RobotGateway(Protocol):
    """Minimum identity shared by simulated and external transports."""
...
class RemoteRobotGateway(RobotGateway, Protocol):
    """Commands required by the real-robot Fleet Manager runtime."""
...
class UnavailableRobotGateway:
    """Neutral core gateway used until a runtime selects a transport."""
...
__all__ = ["RemoteRobotGateway", "RobotGateway", "UnavailableRobotGateway"]
