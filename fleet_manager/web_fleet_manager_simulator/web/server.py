...
DEFAULT_WEB_MAP_DIR = FLEET_ROOT / "map_data" / "maps_out" / "22.05.26_smap.smap"
...
def resolve_map_dir(map_dir: Path) -> Path:
    ...
    candidates = [
        FLEET_ROOT / map_dir,
        FLEET_ROOT / "map_data" / map_dir,
        FLEET_ROOT / "map_data" / "maps_out" / safe_name,
    ]
    if not safe_name.endswith(".smap"):
        candidates.append(FLEET_ROOT / "map_data" / "maps_out" / f"{safe_name}.smap")
