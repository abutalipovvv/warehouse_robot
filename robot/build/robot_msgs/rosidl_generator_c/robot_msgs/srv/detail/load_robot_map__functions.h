...
#ifndef ROBOT_MSGS__SRV__DETAIL__LOAD_ROBOT_MAP__FUNCTIONS_H_
#define ROBOT_MSGS__SRV__DETAIL__LOAD_ROBOT_MAP__FUNCTIONS_H_
...
/// Initialize srv/LoadRobotMap message.
/**
 ...
 * )) before or use
 * robot_msgs__srv__LoadRobotMap_Request__create()
...
/// Finalize srv/LoadRobotMap message.
/**
...
/// Create srv/LoadRobotMap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_msgs__srv__LoadRobotMap_Request__init().
...
/// Destroy srv/LoadRobotMap message.
/**
 * It calls
 * robot_msgs__srv__LoadRobotMap_Request__fini()
...
/// Check for srv/LoadRobotMap message equality.
/**
...
/// Copy a srv/LoadRobotMap message.
/**
...
/// Initialize array of srv/LoadRobotMap messages.
/**
...
/// Finalize array of srv/LoadRobotMap messages.
/**
 * It calls
 * robot_msgs__srv__LoadRobotMap_Request__fini()
...
/// Create array of srv/LoadRobotMap messages.
/**
 * It allocates the memory for the array and calls
 * robot_msgs__srv__LoadRobotMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/LoadRobotMap messages.
/**
 * It calls
 * robot_msgs__srv__LoadRobotMap_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/LoadRobotMap message array equality.
/**
...
/// Copy an array of srv/LoadRobotMap messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * robot_msgs__srv__LoadRobotMap_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_msgs__srv__LoadRobotMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It calls
 * robot_msgs__srv__LoadRobotMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It allocates the memory for the array and calls
 * robot_msgs__srv__LoadRobotMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It calls
 * robot_msgs__srv__LoadRobotMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * robot_msgs__srv__LoadRobotMap_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_msgs__srv__LoadRobotMap_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It calls
 * robot_msgs__srv__LoadRobotMap_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It allocates the memory for the array and calls
 * robot_msgs__srv__LoadRobotMap_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It calls
 * robot_msgs__srv__LoadRobotMap_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_MSGS__SRV__DETAIL__LOAD_ROBOT_MAP__FUNCTIONS_H_
