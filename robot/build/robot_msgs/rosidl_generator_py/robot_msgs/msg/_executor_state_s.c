...
bool robot_msgs__msg__executor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_msgs.msg._executor_state.ExecutorState", full_classname_dest, 44) == 0);
  }
  robot_msgs__msg__ExecutorState * ros_message = _ros_message;
  {  // stamp
  ...
  {  // route_active
    PyObject * field = PyObject_GetAttrString(_pymsg, "route_active");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->route_active = (Py_True == field);
    Py_DECREF(field);
  }
  {  // state
...
{
  /* NOTE(esteve): Call constructor of ExecutorState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_msgs.msg._executor_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExecutorState");
  ...
  {  // route_active
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->route_active ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "route_active", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
