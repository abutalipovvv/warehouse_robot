...
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__robot_msgs__msg__ExecutorState() -> *const std::ffi::c_void;
}

#[link(name = "robot_msgs__rosidl_generator_c")]
extern "C" {
    fn robot_msgs__msg__ExecutorState__init(msg: *mut ExecutorState) -> bool;
    fn robot_msgs__msg__ExecutorState__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<ExecutorState>, size: usize) -> bool;
    fn robot_msgs__msg__ExecutorState__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<ExecutorState>);
    fn robot_msgs__msg__ExecutorState__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<ExecutorState>, out_seq: *mut rosidl_runtime_rs::Sequence<ExecutorState>) -> bool;
}
...
impl Default for ExecutorState {
  fn default() -> Self {
    unsafe {
      ...
      if !robot_msgs__msg__ExecutorState__init(&mut msg as *mut _) {
        panic!("Call to robot_msgs__msg__ExecutorState__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for ExecutorState {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { robot_msgs__msg__ExecutorState__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { robot_msgs__msg__ExecutorState__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { robot_msgs__msg__ExecutorState__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}
...
impl rosidl_runtime_rs::RmwMessage for ExecutorState where Self: Sized {
  const TYPE_NAME: &'static str = "robot_msgs/msg/ExecutorState";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__robot_msgs__msg__ExecutorState() }
  }
}
