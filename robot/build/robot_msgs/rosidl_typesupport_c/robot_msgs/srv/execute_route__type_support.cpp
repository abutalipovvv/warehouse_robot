...
static const _ExecuteRoute_Request_type_support_symbol_names_t _ExecuteRoute_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_msgs, srv, ExecuteRoute_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_msgs, srv, ExecuteRoute_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_msgs, srv, ExecuteRoute_Request)() {
  return &::robot_msgs::srv::rosidl_typesupport_c::ExecuteRoute_Request_message_type_support_handle;
}
...
static const _ExecuteRoute_Response_type_support_symbol_names_t _ExecuteRoute_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_msgs, srv, ExecuteRoute_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_msgs, srv, ExecuteRoute_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_msgs, srv, ExecuteRoute_Response)() {
  return &::robot_msgs::srv::rosidl_typesupport_c::ExecuteRoute_Response_message_type_support_handle;
}
...
static const _ExecuteRoute_Event_type_support_symbol_names_t _ExecuteRoute_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_msgs, srv, ExecuteRoute_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_msgs, srv, ExecuteRoute_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_msgs, srv, ExecuteRoute_Event)() {
  return &::robot_msgs::srv::rosidl_typesupport_c::ExecuteRoute_Event_message_type_support_handle;
}
...
static const _ExecuteRoute_type_support_symbol_names_t _ExecuteRoute_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_msgs, srv, ExecuteRoute)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_msgs, srv, ExecuteRoute)),
  }
};
...
static const rosidl_service_type_support_t ExecuteRoute_service_type_support_handle = {
  ...
  &ExecuteRoute_Request_message_type_support_handle,
  &ExecuteRoute_Response_message_type_support_handle,
  &ExecuteRoute_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robot_msgs, srv, ExecuteRoute)() {
  return &::robot_msgs::srv::rosidl_typesupport_c::ExecuteRoute_service_type_support_handle;
}
