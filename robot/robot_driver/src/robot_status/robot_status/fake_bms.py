"""Publish deterministic battery telemetry for simulated robots."""
...
def fake_battery_state() -> BatteryState:
    """Build the stable battery payload shared by every simulation stack."""
...
class FakeBmsPublisher(Node):
    """Publish a stable BatteryState for stacks without physical BMS hardware."""

    def __init__(self) -> None:
        super().__init__("fake_bms_pub")
        self._publisher = self.create_publisher(BatteryState, "/bms", BMS_QOS)
