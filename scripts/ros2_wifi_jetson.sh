...
export ROS_STATIC_PEERS=192.168.11.104
export CYCLONEDDS_URI="file://${REPO_ROOT}/config/dds/cyclonedds_jetson_wifi.xml"
unset ROS_LOCALHOST_ONLY

echo "ROS 2 Wi-Fi DDS profile: Jetson wlP1p1s0 -> laptop 192.168.11.104, domain ${ROS_DOMAIN_ID}"
