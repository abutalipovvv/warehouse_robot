...
def test_fleet_manager_compat_import_points_to_library() -> None:
    from fleet_manager.mapf.lm_cbs import LmCBSPlanner as CompatPlanner

    assert CompatPlanner is LmCBSPlanner
